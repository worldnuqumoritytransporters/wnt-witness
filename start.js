...
if (require.main === module && !fs.existsSync(appDataDir) && fs.existsSync(path.dirname(appDataDir)+'/wnt-witness')){
	console.log('=== will rename old witness data dir');
	fs.renameSync(path.dirname(appDataDir)+'/wnt-witness', appDataDir);
}
...
var headlessWallet = require('wnt-headless');
